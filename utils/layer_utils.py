...
class QgisAppFieldValueConverter(QgsVectorFileWriter.FieldValueConverter):
    ...
    def __init__(self, source_layer, attributesAsDisplayedValues, attributesExportNames):
        ...
        self.__mAttributesAsDisplayedValues( attributesAsDisplayedValues )
        self.__mAttributesExportNames( attributesExportNames )
        
    def fieldDefinition(self, field: QgsField):
        if self.__mLayer is not None:
            return field
        ...
        if self.__mAttributesAsDisplayedValues.contains( idx ):
            return QgsField( field.name(), QVariant.String )
        
        return field
        
    def convert(self, idx: int, value: QVariant ):
        if not self.__mLayer or not self.__mAttributesAsDisplayedValues.contains( idx ):
            return value
        ...
        return fieldFormatter.representValue( self.__mLayer, idx, setup.config(), QVariant(), value )


    def clone(self):
        return QgisAppFieldValueConverter( self );
...
class LayerUtils: 
    ...
    @staticmethod
    def  saveAsVectorFile(vlayer: QgsVectorLayer, onlySelected: bool, defaultToAddToMap: bool, dialogTitle: str = None, output_formats: list = None) -> str:
