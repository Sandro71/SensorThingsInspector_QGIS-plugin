...
class SensorThingsInspectorPlugin(QObject):
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path=':/plugins/SensorThingsInspector/icons/action-show-panel-icon.png',
            text=self.tr("Setup"),
        ...
        self.inspectoAction = self.add_action(
            icon_path=':/plugins/SensorThingsInspector/icons/action-identify-icon.png',
        ...
        self.exportAction = self.add_action(
            icon_path=':/plugins/SensorThingsInspector/icons/action-export-icon.png',
            text=self.tr("Export"),
